    ...
    >
      ...
      >
        ...
        <p className="mt-3 text-white500 dark:text-white800 xl:w-[29rem]">
          ...
          to excellence since past 3 years.
        </p>
        <div className="mt-9 flex flex-col md:flex-row md:gap-4">
          ...
          >
            <p>banegarhuzzi1010@gmail.com</p>
            <Image
